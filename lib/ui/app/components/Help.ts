    ...
    <div class="page">
      ...
      <div class="card">
        ...
        <dl class="definition-list">
          ...
          <dd>
            Most connection issues happen when the page does not have a <code>body</code> tag. BrowserSync injects its client script near the closing body tag.
          </dd>
          ...
          <dd>
            Use the project issue tracker for this rewrite, and use the BrowserSync docs when checking expected legacy behavior.
          </dd>
        </dl>
        <p class="hint">
